...
---
## main() 메서드가 실행될 때 메모리의 변화-1
ex> 예제 Start.java
```java
public class Start {
	public static void main(String[] args) {
		System.out.println("Hello OOP!!!"); // 3번
	}
}
```
 &nbsp;![](1.자료/이미지/004.png)
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;![](1.자료/이미지/019.png) &nbsp;&nbsp;&nbsp;&nbsp;![](1.자료/이미지/020.png)
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;![](1.자료/이미지/030.png) &nbsp;&nbsp;![](1.자료/이미지/031.png)
...
---
## T 메모리 구조를 활용하여 멀티 쓰레드와 멀티 프로세스 이해
